// https://github.com/playcanvas/engine/blob/60846cc6ad337ebeb879e8d246f9e9b9339fc272/src/framework/parsers/glb-parser.js

import { Debug } from "./debug";
import { Script, Vec3, Vec2 , path, Color, Mat4, math, BoundingBox } from "playcanvas";
import {
...
import { IndexBuffer, Texture, VertexBuffer,VertexFormat  } from 'playcanvas';
...
import { Morph } from 'playcanvas';
import { MorphTarget } from 'playcanvas';
import { calculateNormals } from 'playcanvas';
import { Render } from './render';
import { Skin } from 'playcanvas';
import { StandardMaterial } from 'playcanvas';

import { Entity } from 'playcanvas';
import { INTERPOLATION_CUBIC, INTERPOLATION_LINEAR, INTERPOLATION_STEP } from 'playcanvas';
import { AnimCurve } from 'playcanvas';
import { AnimData } from 'playcanvas';
import { AnimTrack } from 'playcanvas';
import { Asset } from 'playcanvas';
import { ABSOLUTE_URL } from 'playcanvas';

// import { dracoDecode } from 'playcanvas';
...
export const createResources = async (device, gltf, bufferViews, textures, options) => {
...
export const createImages = (gltf, bufferViews, urlBase, registry, options) => {
...
export const createTextures = (gltf, images, options) => {
...
export const loadBuffers = (gltf, binaryChunk, urlBase, options) => {
...
export const parseGltf = (gltfChunk, callback) => {
...
export const parseGlb = (glbData, callback) => {
...
// create buffer views
export const createBufferViews = (gltf, buffers, options) => {
